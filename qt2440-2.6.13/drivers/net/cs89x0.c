...
#elif defined(CONFIG_ARCH_BIT2440)
static unsigned int netcard_portlist[] __initdata = {BIT_VA_CS8900A + DEFAULTIOBASE, 0};
...
#ifdef CONFIG_ARCH_BIT2440	// initialize CS8900
...
#endif
	{
#if !defined(CONFIG_ARCH_IXDP2X01) && !defined(CONFIG_ARCH_BIT2440)
